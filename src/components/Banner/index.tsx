    ...
    return(
        <section className='w-full flex flex-wrap-reverse lg:flex-nowrap justify-center lg:justify-between items-center gap-8'>
            <div className='flex flex-col gap-6 max-w-[550px] items-center lg:items-start'>
                ...
                <a href="#contact"><button className={`${inter.className} text-neutral-900 text-xl font-black uppercase bg-vintage-yellow px-8 py-4 rounded-full border border-neutral-900 hover:text-neutral-900/80 transition-colors`}>Consulte agenda</button></a>
            </div>
