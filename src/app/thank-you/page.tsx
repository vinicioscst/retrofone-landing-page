...
export default function ThankYou() {
  return (
    <div className='h-screen w-full flex flex-col gap-10 items-center justify-center px-10 py-10'>
      ...
      <Link href='/'>
        <button
          className={`${inter.className} text-neutral-900 text-l font-black uppercase bg-vintage-yellow px-6 py-3  rounded-full border border-neutral-900 hover:text-neutral-900/80 transition-colors`}
        >
